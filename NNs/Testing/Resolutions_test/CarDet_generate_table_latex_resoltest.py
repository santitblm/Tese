...
results_path = f"/home/{username}/Desktop/Resultados/Resolutions_test/CarDetect/"
...
print(f''' \\begin{{table}}[!htb]
   \\caption{{FPS for the ALPR system \\textbf{{with}} car detection}}
   \\label{{tab:ALPR_FPS_CarDet}}
   \\centering
   \\renewcommand{{\\arraystretch}}{{1.2}}
   \\begin{{tabular}}{{@{{}}ccrcccc@{{}}}}
    ...
    \\cmidrule{{1-2}}
     ...
     \\midrule
       Large      & Small      && {round((FPS1[0][0]/30)*100)} & {round((FPS1[1][0]/60)*100)} & {round((FPS1[2][0]/30)*100)} & {round((FPS1[3][0]/25)*100)} \\\\
       Large      & Large      && {round((FPS1[0][1]/30)*100)} & {round((FPS1[1][1]/60)*100)} & {round((FPS1[2][1]/30)*100)} & {round((FPS1[3][1]/25)*100)} \\\\
       XLarge     & Small      && {round((FPS1[0][2]/30)*100)} & {round((FPS1[1][2]/60)*100)} & {round((FPS1[2][2]/30)*100)} & {round((FPS1[3][2]/25)*100)} \\\\
       XLarge     & Large      && {round((FPS1[0][3]/30)*100)} & {round((FPS1[1][3]/60)*100)} & {round((FPS1[2][3]/30)*100)} & {round((FPS1[3][3]/25)*100)} \\\\
    \\midrule
    ...
    \\cmidrule{{1-2}}
       Characters & LPs        && 1080p30 & 1080p60 & 2.7K30 & 4K25 \\\\
     \\midrule
       Large      & Small      && {round((FPS2[0][0]/30)*100)} & {round((FPS2[1][0]/60)*100)} & {round((FPS2[2][0]/30)*100)} & {round((FPS2[3][0]/25)*100)} \\\\
       Large      & Large      && {round((FPS2[0][1]/30)*100)} & {round((FPS2[1][1]/60)*100)} & {round((FPS2[2][1]/30)*100)} & {round((FPS2[3][1]/25)*100)} \\\\
       XLarge     & Small      && {round((FPS2[0][2]/30)*100)} & {round((FPS2[1][2]/60)*100)} & {round((FPS2[2][2]/30)*100)} & {round((FPS2[3][2]/25)*100)} \\\\
       XLarge     & Large      && {round((FPS2[0][3]/30)*100)} & {round((FPS2[1][3]/60)*100)} & {round((FPS2[2][3]/30)*100)} & {round((FPS2[3][3]/25)*100)} \\\\
    \\bottomrule
   \\end{{tabular}}
 \\end{{table}}''')
