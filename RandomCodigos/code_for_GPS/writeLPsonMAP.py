...
videos_comp = [[["20240415_155432266.MOV", "R"], ["20240415_155436900.MOV", "L"]], 
               [["20240415_164646933.MOV", "L"], ["20240415_164648500.MOV", "R"]], 
               [["20240416_124741800.MOV", "R"], ["20240416_124743199.MOV", "L"]], 
               [["20240416_144931533.MOV", "R"], ["20240416_144935000.MOV", "L"]], 
               [["20240416_155400300.MOV", "R"], ["20240416_155401733.MOV", "L"]]]


GPS_files = [
            "2024-04-15_15_Apr_2024_15_55_08.gpx",
            "2024-04-15_15_Apr_2024_16_47_28.gpx",
            "2024-04-16_16_Apr_2024_12_52_24.gpx",
            "2024-04-16_16_Apr_2024_14_50_27.gpx",
            "2024-04-16_16_Apr_2024_15_55_03.gpx",
            ]


for videos, GPS_file in zip(videos_comp, GPS_files):
    # Read the GPX file
    gpx_file = open(f'RandomCodigos/code_for_GPS/{GPS_file}', 'r')
    ...
    for video_info in videos:
        ...
        predictions_file = f'/home/santilm/Desktop/Results_LPDet+OCR/Final_Tese/{mode}/{video}/predictions.txt'
    ...
    maps_destination_folder = f'/home/santilm/Desktop/Mapas/{mode}' # Não pode ter / no fim
    if not os.path.isdir(maps_destination_folder):
        os.makedirs(maps_destination_folder)
