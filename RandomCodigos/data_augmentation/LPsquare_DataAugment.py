...
def apply_random_resize(image, path, n):
    
    resize = random.uniform(0.15, 1.0)
    resized_image = cv2.resize(image, None, fx=resize, fy=resize, interpolation=cv2.INTER_CUBIC)
    
    # Get the height and width of the original image
    original_height, original_width, _ = image.shape

    x_center = random.uniform(resize/2, 1-resize/2)
    y_center = random.uniform(resize/2, 1-resize/2)
    width = resize
    height = resize


    # Calculate the coordinates of the top-left corner based on center coordinates
    x_top_left = int((x_center - width / 2) * original_width)
    y_top_left = int((y_center - height / 2) * original_height)
    ...
    new_image = np.full_like(image, background_color, dtype=np.uint8)
...
def create_new_images(images_path = "C:/Users/Vastingood/Downloads/LPs_quadradas/transformed/", new_images_path = "C:/Users/Vastingood/Downloads/LPs_quadradas/train/images/", new_labels_path = "C:/Users/Vastingood/Downloads/LPs_quadradas/train/labels/"):
...
def transforms(images_path = "C:/Users/Vastingood/Downloads/LPs_quadradas/train/images/", labels_path = "C:/Users/Vastingood/Downloads/LPs_quadradas/train/images/"):
